...
* I request from you a short project summary based on available information in the project README.
* Read the README and categorize the available information based on the structure given below for
your response.
