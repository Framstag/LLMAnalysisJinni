...
Provides tools and evaluation tasks for identifying data class candidates across production, test, and generated code in a module. A class is flagged as a data class candidate if all its fields are private and all its methods are getters, setters, or constructors; or all its fields are public with no business logic methods.
...
- **THEN** the system returns a list of class names identified as data class candidates
