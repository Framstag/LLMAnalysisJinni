...
* Evaluate circular dependencies across all Java modules in one batch task.
* Call **`java_get_all_circular_dependency_reports`** once.
...
* Call `java_get_all_circular_dependency_reports`.
