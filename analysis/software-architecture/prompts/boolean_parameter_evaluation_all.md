...
* Evaluate boolean parameter usage across all Java modules in one batch task.
* Call **`java_get_all_boolean_parameter_reports`** once.
...
* Call `java_get_all_boolean_parameter_reports`.
