...
* Evaluate method count per class across all Java modules in one batch task.
* Call **`java_get_all_method_count_reports`** once.
...
* Call `java_get_all_method_count_reports`.
