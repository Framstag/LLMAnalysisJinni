...
* Evaluate cyclomatic complexity across all Java modules in one batch task.
* Call **`java_get_all_cyclomatic_complexity_reports`** once.
...
* Call `java_get_all_cyclomatic_complexity_reports`.
