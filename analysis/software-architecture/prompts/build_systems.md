...
* To look for certain files, use the filesystem_get_matching_files_in_dir_recursively tool. Pass to it the root directory and a list of wildcard expressions matching files of the various build systems.
