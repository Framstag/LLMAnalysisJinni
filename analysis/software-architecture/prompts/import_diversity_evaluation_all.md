...
* Evaluate import diversity across all Java modules in one batch task.
* Call **`java_get_all_import_diversity_reports`** once.
...
* Call `java_get_all_import_diversity_reports`.
