...
* Evaluate method complexity metrics across all Java modules in one batch task.
* Call **`java_get_all_method_complexity_reports`** once.
...
* Call `java_get_all_method_complexity_reports`.
