...
* Evaluate inheritance patterns across all Java modules in one batch task.
* Call **`java_get_all_inheritance_reports`** once.
...
* Call `java_get_all_inheritance_reports`.
