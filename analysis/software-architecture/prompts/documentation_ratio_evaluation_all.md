...
* Evaluate documentation coverage across all Java modules in one batch task.
* Call **`java_get_all_documentation_ratio_reports`** once.
...
* Call `java_get_all_documentation_ratio_reports`.
