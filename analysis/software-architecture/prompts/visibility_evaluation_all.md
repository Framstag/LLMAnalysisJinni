...
* Evaluate method visibility distributions across all Java modules in one batch task.
* Call **`java_get_all_visibility_distribution_reports`** once.
...
* Call `java_get_all_visibility_distribution_reports`.
